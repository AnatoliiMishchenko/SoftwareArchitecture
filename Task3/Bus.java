...
public class Bus extends Car implements GasStation{

    public Bus(String model, String brand, String color, String bodyType, int cnumberOfWheels) {
    ...
    public void refueling() {
        System.out.println("автомобиль ездиет на газе");;
    }
